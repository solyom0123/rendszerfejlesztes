...
final class Version20210502081706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE food ADD sale_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE menu ADD sale_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE suborder_food ADD PRIMARY KEY (suborder_id, food_id)');
    }
